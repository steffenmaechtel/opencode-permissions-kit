...
ui_add   "/mnt/c hardening snippet"         "printed (manual, applies after wsl --shutdown)"
...
ui_plan 5 "Print /mnt/c hardening snippet"             "manual — the kit never writes wsl.conf"
...
ui_info "Printing /mnt/c hardening snippet..."
sim 0.3
ui_success "snippet printed — apply it yourself, then 'wsl --shutdown'"
ui_detail "login fix (optional): sudo opk wsl-add-opencode-1-fix"
